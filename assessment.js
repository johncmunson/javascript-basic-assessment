...
// #9 Write a function called addItem that takes in an array, an item, and adds the item to the array
...
function coderTest(obj) {
	...
	if (obj.name !== 'Jeremy' && obj.name !== 'Brack') {
		obj.lovesCode = 5;
	}
}
